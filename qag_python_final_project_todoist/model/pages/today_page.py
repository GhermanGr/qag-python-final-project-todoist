...
class TodayPage():
    ...
    def create_task(self, task_name):
        ...
        sleep(1) # Небольшой период ожидания позволяет убедиться, что задача успела создаться,
    ...
    def complete_task(self, task_id):
        ...
        sleep(60) # Почему-то список выполненных заданий обновляется не сразу, нужно подождать
